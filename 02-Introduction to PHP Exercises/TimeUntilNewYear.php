...
/*
  Problem 14. * *Time Until New Year
...
echo "Days:Hours:Minutes:Seconds {$daysUntilNewYear}:{$formattedHoursUntilNewYear}:{$formattedMinutesUntilNewYear}:{$formattedSecondsUntilNewYear}";
